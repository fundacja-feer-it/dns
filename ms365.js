function Ms365_Subdomain(domainPrefix, domainRoot, escapedO365DomainKey) {
    ...
    return [
        ...
        // DKIM records
        CNAME('selector1._domainkey.' + domainPrefix, 'selector1-' + escapedO365DomainKey + '._domainkey.fundacjafeer.onmicrosoft.com.'),
        CNAME('selector2._domainkey.' + domainPrefix, 'selector2-' + escapedO365DomainKey + '._domainkey.fundacjafeer.com.')
    ];
};
...
function Ms365_Root(domain) {
    ...
    return [
        ...
        // DKIM records
        CNAME('selector1._domainkey', 'selector1-' + domainSingleLabel + '._domainkey.fundacjafeer.onmicrosoft.com.'),
        CNAME('selector2._domainkey', 'selector2-' + domainSingleLabel + '._domainkey.fundacjafeer.onmicrosoft.com.'),
